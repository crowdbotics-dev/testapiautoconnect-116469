...
## Project Structure
    ...
    ├── testapiautoconnect_116469  # Django project configurations
...
1. Clone this repo and `cd testapiautoconnect_116469`
...
2. Clone this repo and `cd testapiautoconnect_116469`
